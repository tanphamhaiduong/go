...
func (_m *IRepository) Count(ctx context.Context, params arguments.PermissionCountArgs) (int64, error) {
...
func (_m *IRepository) Delete(ctx context.Context, params arguments.PermissionDeleteArgs) (int64, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRepository) GetByID(ctx context.Context, params arguments.PermissionGetByIDArgs) (models.Permission, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRepository) GetByIDs(ctx context.Context, params arguments.PermissionGetByIDsArgs) ([]models.Permission, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRepository) Insert(ctx context.Context, params arguments.PermissionInsertArgs) (models.Permission, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRepository) List(ctx context.Context, params arguments.PermissionListArgs) ([]models.Permission, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRepository) Update(ctx context.Context, params arguments.PermissionUpdateArgs) (models.Permission, error) {
	ret := _m.Called(ctx, params)
