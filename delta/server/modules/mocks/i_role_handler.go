...
// IRoleHandler is an autogenerated mock type for the IRoleHandler type
type IRoleHandler struct {
	mock.Mock
}

// Count provides a mock function with given fields: ctx, params
func (_m *IRoleHandler) Count(ctx context.Context, params arguments.RoleCountArgs) (int64, error) {
...
func (_m *IRoleHandler) Delete(ctx context.Context, params arguments.RoleDeleteArgs) (int64, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRoleHandler) GetByID(ctx context.Context, params arguments.RoleGetByIDArgs) (models.Role, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRoleHandler) Insert(ctx context.Context, params arguments.RoleInsertArgs) (models.Role, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRoleHandler) List(ctx context.Context, params arguments.RoleListArgs) ([]models.Role, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRoleHandler) Update(ctx context.Context, params arguments.RoleUpdateArgs) (models.Role, error) {
	ret := _m.Called(ctx, params)
