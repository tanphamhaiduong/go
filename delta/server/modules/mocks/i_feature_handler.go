...
// IFeatureHandler is an autogenerated mock type for the IFeatureHandler type
type IFeatureHandler struct {
	mock.Mock
}

// Count provides a mock function with given fields: ctx, params
func (_m *IFeatureHandler) Count(ctx context.Context, params arguments.FeatureCountArgs) (int64, error) {
...
func (_m *IFeatureHandler) Delete(ctx context.Context, params arguments.FeatureDeleteArgs) (int64, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IFeatureHandler) GetByID(ctx context.Context, params arguments.FeatureGetByIDArgs) (models.Feature, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IFeatureHandler) Insert(ctx context.Context, params arguments.FeatureInsertArgs) (models.Feature, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IFeatureHandler) List(ctx context.Context, params arguments.FeatureListArgs) ([]models.Feature, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IFeatureHandler) Update(ctx context.Context, params arguments.FeatureUpdateArgs) (models.Feature, error) {
	ret := _m.Called(ctx, params)
