...
// IRolePermissionHandler is an autogenerated mock type for the IRolePermissionHandler type
type IRolePermissionHandler struct {
	mock.Mock
}

// Count provides a mock function with given fields: ctx, params
func (_m *IRolePermissionHandler) Count(ctx context.Context, params arguments.RolePermissionCountArgs) (int64, error) {
...
func (_m *IRolePermissionHandler) Delete(ctx context.Context, params arguments.RolePermissionDeleteArgs) (int64, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRolePermissionHandler) GetByID(ctx context.Context, params arguments.RolePermissionGetByIDArgs) (models.RolePermission, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRolePermissionHandler) Insert(ctx context.Context, params arguments.RolePermissionInsertArgs) (models.RolePermission, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRolePermissionHandler) List(ctx context.Context, params arguments.RolePermissionListArgs) ([]models.RolePermission, error) {
	ret := _m.Called(ctx, params)
...
func (_m *IRolePermissionHandler) Update(ctx context.Context, params arguments.RolePermissionUpdateArgs) (models.RolePermission, error) {
	ret := _m.Called(ctx, params)
